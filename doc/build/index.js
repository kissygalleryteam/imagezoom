 ...
 */
KISSY.add('kg/imagezoom/2.0.0/index',function (S, Node, Overlay, Base, undefined) {
    var $ = Node.all,
 ...
 *
 * 202.0.0504 by yiminghe@gmail.com
 *  - refactor
 *  - fix bug: show 前 hasZoom 设了无效
 *
 * 202.0.01 by qiaohua@taobao.com
 *  - 重构代码, 基于 UIBase
 */
